function heredaDe(prototipoHijo, prototipoPadre) {
    ...
    // Aquí se obtiene los prototipos del padre
    prototipoHijo.prototype = new fn
    // Aqui se apunta al constructor del prototipo hijo
...
var objeto1 = new Persona('Jorge', 'Parrales', 1.70)
objeto1.saludar()
objeto1.soyAlto()

var objeto2 = new Deportista('Yomar', 'Toala')
objeto2.saludar()
